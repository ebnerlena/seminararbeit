...
\acrodef{HMD}[HMD]{head-mounted displays}
\acrodef{VR}[VR]{Virtual Reality}
\acrodef{TUI}[TUI]{tangible user interfaces}
\acrodef{DOF}[DOF]{degree-of-freedom}
\acrodef{OHF}[OHF]{one-handed flying}
\acrodef{FOV}[FOV]{field of view}
\acrodef{THF}[THF]{two-handed flying}
\acrodef{CAST}[CAST]{context-aware selection techniques}
\acrodef{WIM}[WIM]{World in Miniature}
\acrodef{DR}[DR]{dimensional reduction}
